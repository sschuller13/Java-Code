...
import edu.uic.ids.console.Assignment6;
public class Assignment6Driver {
	public static void main(String[] args) {
			String continues = "";
			Scanner sc = new Scanner(System.in);
			Scanner sc2 = new Scanner(System.in);
			Assignment6 shape = null;
			String shapeType = "";
			double length = 0.0;
			double width = 0.0;
			double radius = 0.0;
			String delim = null;
			String d = null;
			System.out.println("IDS401 Assignment 6 - Shape Area & Perimeter calculator with File Exporter \n");
			System.out.println("Enter max number of shapes: ");
			int maxNumberShapes = sc.nextInt();
			Assignment6 shapeArray [] = new Assignment6[maxNumberShapes];
			int Number = 0;
			while(!continues.equalsIgnoreCase("n")) { // assumes at least one
				shape = new Assignment6();
			...
			try {
				...
				for(int i =0; i < shapeArray.length;i++) {
					// creates printwriter of array to output into a file
